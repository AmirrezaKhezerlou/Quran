          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("آیه ها: ${widget.chapterData!.ayahs!.length}"),
                Text("شماره سوره: ${widget.chapterData!.number!}"),
                Text("تفسیر: ${widget.chapterData!.revelationType!}"),
                Text("معنی: ${widget.chapterData!.englishNameTranslation!}"),
                SizedBox(
                  height: height * 0.02,
                ),
                SizedBox(
