              ...
              child: BlocBuilder<ChapterCubit, ChapterState>(
                builder: (context, state) {
                  if (state is ChapterFetchLoading) {
                    return Directionality(textDirection: TextDirection.rtl,child: const Text('درحال دریافت سوره ها...',style: TextStyle(fontFamily: 'iransans')));
                  } else if (bookmarkCubit.state is BookmarkFetchLoading) {
                    return Directionality(textDirection: TextDirection.rtl,child: const Text('دریافت لیست ذخیره شده ...',style: TextStyle(fontFamily: 'iransans')));
                  } else if (juzCubit.state is JuzFetchLoading) {
                    return Directionality(textDirection: TextDirection.rtl,child: const Text('تنظیم حالت آفلاین ...',style: TextStyle(fontFamily: 'iransans'),));
                  }
                  return Directionality(textDirection: TextDirection.rtl,child: const Text('دریافت دیتا ...',style: TextStyle(fontFamily: 'iransans')));
                },
              ),
            ),
          ],
